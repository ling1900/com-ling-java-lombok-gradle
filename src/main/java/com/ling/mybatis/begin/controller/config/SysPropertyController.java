...
//    @NeedPms(Pms.SysPropertyQuery)
    ...
    @ApiOperation(value = "创建系统配置（事务）")
    @PostMapping(CmdCode.SysPropertyCreateWithTransaction + ".do")
//    @NeedPms(Pms.SysPropertyCreate)
    public DglgResponse createWithTransaction(@RequestBody SysPropertyCreateRequest request) {
        return sysPropertyService.createWithTransaction(request);
    }

    @ApiOperation(value = "创建系统配置（无事务）")
    @PostMapping(CmdCode.SysPropertyCreateWithoutTransaction + ".do")
//    @NeedPms(Pms.SysPropertyCreate)
    public DglgResponse createWithoutTransaction(@RequestBody SysPropertyCreateRequest request) {
        return sysPropertyService.createWithoutTransaction(request);
    }
